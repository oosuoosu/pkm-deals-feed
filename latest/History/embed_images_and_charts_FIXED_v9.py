...
# === CONFIG ===
INPUT_FILE = "Filtered_NoImages_ApprovedOnly_20250613_2130.xlsx"
    ...
    if isinstance(img_url, str) and img_url.startswith("http"):
        try:
            ...
            if resp.status_code == 200:
                ...
                asin_folder = os.path.join(ASSET_DIR, asin)
                os.makedirs(asin_folder, exist_ok=True)
                img_path = os.path.join(asin_folder, "image.jpg")
...
# === SAVE ===
wb.save(OUTPUT_FILE)
print(f"✅ Done. Excel saved: {OUTPUT_FILE}")
print(f"🗂️ Images saved in folders under: {ASSET_DIR}")
