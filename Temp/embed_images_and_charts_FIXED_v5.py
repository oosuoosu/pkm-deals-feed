...
# === CONFIG ===
INPUT_FILE = "Final_Enriched_Affiliate_Sheet_Styled_20250611_1600.xlsx"
...
def generate_chart(asin):
    try:
        ...
        buy_box_data = product["csv"][10]  # Buy Box price history

        # Last 720 entries (~30 days if hourly)
        recent = buy_box_data[-720:]
        ...
        plt.title("Buy Box Price (30 days)")
        plt.ylabel("¥")
        plt.grid(True)
        plt.tight_layout()
